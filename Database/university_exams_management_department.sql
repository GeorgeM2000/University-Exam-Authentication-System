...
CREATE TABLE `department` (
  ...
  `annual_budget` double DEFAULT NULL,
...
INSERT INTO `department` VALUES ('Computer Science','2000-06-27',100000.563,50,1100),('Mathematics','2019-11-03',50678.3654,32,500);
